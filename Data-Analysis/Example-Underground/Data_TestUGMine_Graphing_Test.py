...
def autoplotting(num_list, datetime_list, temp_list, press_list, humidity_list):
    ...
    for i in range(0,6,2):
        plt.plot(datetime_list[i], temp_list[i], label = 'Temperature 1')
        plt.plot(datetime_list[i+1], temp_list[i+1], label = 'Temperature 2')
        plt.title('Temperature Comparison\n Time Period: ' +str(datetime_list[i][0])+ ' - ' +str(datetime_list[i][-1]))
        legend = plt.legend(loc='upper right', shadow=True, fontsize='x-large')
        plt.show()

        plt.plot(datetime_list[i], press_list[i], label = 'Pressure 1')
        plt.plot(datetime_list[i+1], press_list[i+1], label = 'Pressure 2')
        plt.title('Pressure Comparison\n Time Period: ' +str(datetime_list[i][0])+ ' - ' +str(datetime_list[i][-1]))
        legend = plt.legend(loc='upper right', shadow=True, fontsize='x-large')
        plt.show()

        plt.plot(datetime_list[i], humidity_list[i], label = 'Humidity 1')
        plt.plot(datetime_list[i+1], humidity_list[i+1], label = 'Humidity 2')
...
def main():
    ...
    last_recording1 = datetime.datetime.strptime("11/17/2016 14:30:00", "%m/%d/%Y %H:%M:%S")
    ...
    first_recording2 = datetime.datetime.strptime("11/18/2016 09:00:00", "%m/%d/%Y %H:%M:%S")
    last_recording2 = datetime.datetime.strptime("11/18/2016 14:30:00", "%m/%d/%Y %H:%M:%S")
